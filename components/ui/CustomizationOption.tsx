...
const CustomizationOption = () => {
  ...
  return (
    <div className="flex flex-col gap-6 my-2 select-none">
      <div
        onClick={() => {
      ...
      {customizationOption === "catalogo" && (
        <>
          ...
          <button className="flex justify-center bg-vermelho text-white rounded-sm py-3 w-full active:scale-99 transition cursor-pointer md:max-w-90">
      ...
      >
        ...
        <div>
          ...
          <p className="font-medium text-gray-600  text-xs">
            Quer algo único? Fale com a gente pelo Whatsapp
          </p>
        </div>
      </div>
    </div>
